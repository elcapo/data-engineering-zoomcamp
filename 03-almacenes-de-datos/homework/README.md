...
The parquet Files can be found here:
- https://www.nyc.gov/site/tlc/about/tlc-trip-record-data.page

If you are using orchestration such as Kestra, Mage, Airflow or Prefect, do not load the data into Big Query using the orchestrator. Just load the files into a bucket.
