...
Usage:
    ...
    e.g. 2, "Climate vs Development", 2-climate-vs-development
"""
...
def main():
    ...
    ap.add_argument("ref", help="Dashboard id, exact name, or url-slug (e.g. 2-climate-vs-development)")
    args = ap.parse_args()
    ...
    out_dir = root / "metabase" / "serialized" / slug
