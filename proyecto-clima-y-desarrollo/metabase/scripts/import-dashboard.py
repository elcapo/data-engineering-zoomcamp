#!/usr/bin/env python3
"""Import a Metabase dashboard previously exported by export-dashboard.py.
...
def main():
    ...
    ap.add_argument("export_dir", type=Path, help="Folder produced by export-dashboard.py")
