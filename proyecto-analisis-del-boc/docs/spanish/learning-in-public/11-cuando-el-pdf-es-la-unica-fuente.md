En el artículo sobre la organización de los flujos mencioné que algunos de los boletines del Boletín Oficial de Canarias (BOC) no tienen versión HTML y que había implementado extracciones directamente desde PDF. Me explico.

El archivo histórico del BOC abarca más de cuarenta años. Casi todos los boletines más recientes tienen un índice HTML con enlaces a cada disposición pero algunos más antiguos solo están en PDF.

Extraer estructura de un PDF no es como parsear HTML. En un HTML tienes etiquetas que dicen "esto es un encabezado" o "esto es un enlace". En un PDF solo tienes caracteres sueltos con una posición en la página, un tamaño y un nombre de fuente. No hay jerarquía, no hay semántica: los PDF son Mad Max.
