...
> [!NOTE]
> Hay una página con documentación específica sobre las [fuentes de datos](pipeline/docs/kestra/01-fuentes-de-datos.md) que incluye un detalle sobre cómo se ha implementado cada uno de los flujos de ingestión.
